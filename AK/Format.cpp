...
ErrorOr<void> Formatter<Error>::format(AK::FormatBuilder& builder, const AK::Error& error)
{
#if defined(AK_OS_SERENITY) && defined(KERNEL)
    ...
    return Formatter<FormatString>::format(builder, "{}"sv, TRY(error.format_impl()));
#endif
}
