...
enum class AllFlags {
    ...
    Internal_EmitDebugInfo = __Regex_Internal_EmitDebugInfo,     // Emit debug information (regex source <=> generated bytecode correlation information)
    Last = Internal_EmitDebugInfo,
};
...
enum class PosixFlags : FlagsUnderlyingType {
    ...
    EmitDebugInfo = (FlagsUnderlyingType)AllFlags::Internal_EmitDebugInfo,
};
